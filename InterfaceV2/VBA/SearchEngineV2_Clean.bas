...
Public Function ExecuteSmartSearch(searchTerm As String) As DataTypes.SearchResult()
    Dim results() As DataTypes.SearchResult
    Dim resultCount As Long
    Dim allFiles() As String
    Dim i As Long
    Dim tempResult As DataTypes.SearchResult
    ...
    For i = LBound(allFiles) To UBound(allFiles)
        If i <= UBound(allFiles) And allFiles(i) <> "" Then
...
Private Function SearchFile(filePath As String, searchTerm As String) As DataTypes.SearchResult
    ...
    result.FileType = FileUtilities.GetFileTypeFromPath(filePath)
...
Private Function SearchFileContent(filePath As String, searchTerm As String, ByRef result As DataTypes.SearchResult) As Integer
    Dim wb As Workbook
    Dim ws As Worksheet
    Dim score As Integer
...
Private Function RankResults(results() As DataTypes.SearchResult) As DataTypes.SearchResult()
    Dim i As Long, j As Long
    Dim temp As DataTypes.SearchResult
